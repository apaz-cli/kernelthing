...
- Has implementer been advancing mainline ACs, or mostly clearing side issues?
...
- Verify implementer's claims match reality
...
- implementer making the same mistakes repeatedly
- Circular discussions without resolution
- No new code changes despite continued iterations
- reviewer giving similar feedback repeatedly without implementer addressing it
...
- Include specific action items for implementer to address, classified into:
  - Mainline Gaps
