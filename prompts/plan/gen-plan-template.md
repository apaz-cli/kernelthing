...
- `coding`: implemented by implementer
- `analyze`: executed via reviewer (`/humanize:ask-codex`)
...
## implementer-reviewer Deliberation

### Agreements
- <Point both sides agree on>

### Resolved Disagreements
- <Topic>: implementer vs reviewer summary, chosen resolution, and rationale
